...
import com.har.domains.Owner;
import com.har.domains.Vehicle;
import com.har.utility.HibernateUtil;

public class OneToManyBiManyToOneTest {

	public static void main(String[] args) {
		//oneToManyBiManyToOneXml();
		OneToManyBiManyToOneAnnoTest.oneToManyBiManyToOneAnno();
	}
	
	
 private static void oneToManyBiManyToOneXml(){
